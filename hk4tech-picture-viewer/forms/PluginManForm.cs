	...
	public partial class PluginManForm : QlibFixedForm
	{
		...
		private void SetDarkMode(bool dark)
		{
			if (dark)
			{
				...
				addPluginBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_open;
				morePluginsBtn.BackColor = ThemeMan.DarkSecondColor;
				morePluginsBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_plugin;
				deleteBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_trash;
				pluginWebsiteBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_website;
				refreshBtn.BackColor = ThemeMan.DarkSecondColor;
				refreshBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_sync;
			}
			DarkMode = dark;
		...
		private void RefreshPluginsList()
		{
			...
			for (int i = 0; i < plugins.Length; i++)
			{
				...
				var listViewItem = new ListViewItem(new string[] {
					plugins[i].title,
					plugins[i].description.Get(hk4tech_picture_viewer.Properties.Settings.Default.Language),
					authors,
					"v" + plugins[i].version
				});
		...
		{
			Process.Start("https://github.com/AhmedNasserHK");
		}
		...
		{
			hk4tech_picture_viewer.Properties.Settings.Default.PluginsCache = PluginMan.GenerateCacheStr();
