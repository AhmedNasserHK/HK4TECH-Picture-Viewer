...
namespace hk4tech_picture_viewer
{
	public partial class SelectionForm : Form
	{
		...
		public SelectionForm(Panel srcPanel, bool darkMode)
		{
			...
			if (darkMode)
			{
				cutBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_cut;
				cropBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_crop;
				selectionCopyBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_copy;
				selectionSelectAllBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_selectall;
				editSelectionBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_editsel;
			}
		}
