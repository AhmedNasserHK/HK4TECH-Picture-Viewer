...
namespace hk4tech_picture_viewer
{
	public partial class MiniViewForm : QlibFixedForm
	{
		...
		public MiniViewForm(Bitmap image, string title, bool checkboardBackground)
		{
			...
			if (hk4tech_picture_viewer.Properties.Settings.Default.PipOpacity == 0.25 || hk4tech_picture_viewer.Properties.Settings.Default.PipOpacity == 0.75) Opacity = hk4tech_picture_viewer.Properties.Settings.Default.PipOpacity;
		}

		private void picturePanel_MouseWheel(object sender, MouseEventArgs e)
		{
			if (ModifierKeys == Keys.Control || hk4tech_picture_viewer.Properties.Settings.Default.MouseWheelScrollAction == 1)
			{
				if (e.Delta > 0) zoomIn();
		...
		private void opacityBtn_Click(object sender, EventArgs e)
		{
			...
			hk4tech_picture_viewer.Properties.Settings.Default.PipOpacity = Opacity;
