	...
	partial class InfoForm : QlibFixedForm
	{
		...
		private void SetDarkMode(bool dark)
		{
			if (dark)
			{
				...
				propertiesButton.Image = hk4tech_picture_viewer.Properties.Resources.white_imgfile;

				copyNameButton.Image = hk4tech_picture_viewer.Properties.Resources.white_copy;
				copyNameButton.BackColor = ThemeMan.DarkSecondColor;
				copyFolderButton.Image = hk4tech_picture_viewer.Properties.Resources.white_copy;
				copyFolderButton.BackColor = ThemeMan.DarkSecondColor;
				copyPathButton.Image = hk4tech_picture_viewer.Properties.Resources.white_copy;
