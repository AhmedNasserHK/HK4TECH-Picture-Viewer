...
namespace hk4tech_picture_viewer
{
	public partial class MainForm : Form
	{
		...
		public MainForm(string openPath, bool darkMode)
		{
			...
			toolStrip1.Visible = hk4tech_picture_viewer.Properties.Settings.Default.ShowToolbar;
			statusStrip1.Visible = hk4tech_picture_viewer.Properties.Settings.Default.ShowStatusBar;

			if (hk4tech_picture_viewer.Properties.Settings.Default.StartupRestoreBounds)
			{
				Screen curScreen = Screen.FromPoint(Cursor.Position);
				if (
					hk4tech_picture_viewer.Properties.Settings.Default.StartupWindowLocation.X < curScreen.WorkingArea.X - 128 ||
					hk4tech_picture_viewer.Properties.Settings.Default.StartupWindowLocation.Y < curScreen.WorkingArea.Y - 128 ||
					hk4tech_picture_viewer.Properties.Settings.Default.StartupWindowLocation.X >= curScreen.WorkingArea.X + curScreen.WorkingArea.Width - 128 ||
					hk4tech_picture_viewer.Properties.Settings.Default.StartupWindowLocation.Y >= curScreen.WorkingArea.Y + curScreen.WorkingArea.Height - 128
				)
				{
				...
				else
				{
					...
					Location = hk4tech_picture_viewer.Properties.Settings.Default.StartupWindowLocation;
				}

				if (hk4tech_picture_viewer.Properties.Settings.Default.StartupWindowSize.Width >= MinimumSize.Width && hk4tech_picture_viewer.Properties.Settings.Default.StartupWindowSize.Height >= MinimumSize.Height)
				{
					Size = hk4tech_picture_viewer.Properties.Settings.Default.StartupWindowSize;
				}
				else
				{
					hk4tech_picture_viewer.Properties.Settings.Default.StartupWindowSize = new Size(700, 485);
				}
			}
		...
		{
			if (string.IsNullOrEmpty(hk4tech_picture_viewer.Properties.Settings.Default.Language))
			{
				switch (CultureInfo.CurrentCulture.TwoLetterISOLanguageName)
				{
					...
					case "hu":
					case "ru":
						LangMan.Init("hk4tech_picture_viewer", "hk4tech_picture_viewer.languages.lang_" + CultureInfo.CurrentCulture.TwoLetterISOLanguageName);
						hk4tech_picture_viewer.Properties.Settings.Default.Language = CultureInfo.CurrentCulture.TwoLetterISOLanguageName;
						break;
					default:
						LangMan.Init("hk4tech_picture_viewer");
						hk4tech_picture_viewer.Properties.Settings.Default.Language = LangMan.defaultLang;
						break;
				}
			...
			{
				LangMan.Init("hk4tech_picture_viewer", "hk4tech_picture_viewer.languages.lang_" + hk4tech_picture_viewer.Properties.Settings.Default.Language);
			}
		...
		{
			slideshowCounter++;
			if (slideshowCounter >= hk4tech_picture_viewer.Properties.Settings.Default.SlideshowTime)
			{
				slideshowCounter = 0;
				NextFile();
			}

			if (hk4tech_picture_viewer.Properties.Settings.Default.SlideshowCounter)
			{
				if ((hk4tech_picture_viewer.Properties.Settings.Default.SlideshowTime - slideshowCounter) <= 1)
				{
					showSuggestion(LangMan.Get("next-image-in-1-second"), SuggestionIcon.Slideshow);
				}
				else
				{
					showSuggestion(string.Format(LangMan.Get("next-image-in-x-seconds"), hk4tech_picture_viewer.Properties.Settings.Default.SlideshowTime - slideshowCounter), SuggestionIcon.Slideshow);
				}
			}
		}
		...
		protected override void OnLoad(EventArgs e)
		{
			try
			{
				if (string.IsNullOrEmpty(openPath))
				{
					...
					if (hk4tech_picture_viewer.Properties.Settings.Default.StartupPaste && Clipboard.ContainsImage())
					{
			...
			setAlwaysOnTop(hk4tech_picture_viewer.Properties.Settings.Default.AlwaysOnTop, false);
			setCheckboardBackground(hk4tech_picture_viewer.Properties.Settings.Default.CheckboardBackground, false);
			nextButton.Visible = !hk4tech_picture_viewer.Properties.Settings.Default.ShowNavArrows;

			if (hk4tech_picture_viewer.Properties.Settings.Default.StartupMaximize) WindowState = FormWindowState.Maximized;

			if (hk4tech_picture_viewer.Properties.Settings.Default.BackColor.Length > 0)
			{
				picturePanel.BackColor = Color.FromArgb(Convert.ToInt32(hk4tech_picture_viewer.Properties.Settings.Default.BackColor));
			}

			UpdateMan.Init("ModuleArt", "hk4tech-picture-viewer", "QuickPictureViewer-Setup.exe", darkMode, hk4tech_picture_viewer.Properties.Settings.Default.SkippedVersion);
			...
			if (hk4tech_picture_viewer.Properties.Settings.Default.CheckForUpdates) UpdateMan.CheckForUpdates(false, TopMost, Handle);
		...
		{
			hk4tech_picture_viewer.Properties.Settings.Default.SkippedVersion = e.SkippedVersion;
		}
		...
		public void openImage(Bitmap bitmap, string directoryName, string fileName)
		{
			if (bitmap != originalImage)
			{
				...
				else
				{
					...
					if (recursiveFolder != null) directoryLabel.Image = darkMode ? hk4tech_picture_viewer.Properties.Resources.white_recursive : hk4tech_picture_viewer.Properties.Resources.black_recursive;
					else directoryLabel.Image = darkMode ? hk4tech_picture_viewer.Properties.Resources.white_picfolder : hk4tech_picture_viewer.Properties.Resources.black_picfolder;
				...
				Invoke((MethodInvoker)(() => Text = fileName + " - HK4TECH Picture Viewer"));
		...
		private void setImageChanged(bool b, string fakeName = "")
		{
			...
			Text = string.IsNullOrEmpty(fakeName) ? currentFile + " - HK4TECH Picture Viewer" : fakeName + " - HK4TECH Picture Viewer";
		...
		private void setAlwaysOnTop(bool b, bool saveToDisk)
		{
			...
			if (saveToDisk)
			{
				hk4tech_picture_viewer.Properties.Settings.Default.AlwaysOnTop = b;
				hk4tech_picture_viewer.Properties.Settings.Default.Save();
			}
		}
		...
		public void setCheckboardBackground(bool b, bool saveToDisk)
		{
			...
			if (b)
			{
				if (!fullscreen)
				{
					...
					hk4tech_picture_viewer.Properties.Settings.Default.BackColor = "";
					hk4tech_picture_viewer.Properties.Settings.Default.Save();
			...
			if (saveToDisk)
			{
				hk4tech_picture_viewer.Properties.Settings.Default.CheckboardBackground = b;
				hk4tech_picture_viewer.Properties.Settings.Default.Save();
			}
		}
		...
		private void picturePanel_MouseWheel(object sender, MouseEventArgs e)
		{
			if (originalImage != null)
			{
				if (Control.ModifierKeys == Keys.Control || hk4tech_picture_viewer.Properties.Settings.Default.MouseWheelScrollAction == 1)
				{
					if (e.Delta > 0) zoomIn();
					else if (e.Delta < 0) zoomOut();
				}
				else if (hk4tech_picture_viewer.Properties.Settings.Default.MouseWheelScrollAction == 2)
				{
		...
		private void setFullscreen(bool b)
		{
			...
			if (b)
			{
				...
				if (!hk4tech_picture_viewer.Properties.Settings.Default.ShowCursorInFullscreen)
				{
			...
			else
			{
				...
				{
					if (hk4tech_picture_viewer.Properties.Settings.Default.BackColor.Length > 0) picturePanel.BackColor = Color.FromArgb(Convert.ToInt32(hk4tech_picture_viewer.Properties.Settings.Default.BackColor));
				...
				else
				{
					...
					else if (e.KeyCode == Keys.Escape)
					{
						...
						else
						{
							...
							else if (hk4tech_picture_viewer.Properties.Settings.Default.EscToExit) Close();
						}
					}
		...
		private void SetDarkMode(bool dark)
		{
			if (dark)
			{
				...
				openBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_open;
				openFileBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_imgfile;
				openFolderBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_picfolder;
				openRecursive.Image = hk4tech_picture_viewer.Properties.Resources.white_recursive;

				saveAsBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_saveas;
				saveMenuBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_save;
				saveBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_save;
				printButton.Image = hk4tech_picture_viewer.Properties.Resources.white_print;
				deleteBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_trash;
				permDeleteBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_permdel;

				externalBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_popup;
				externalRunBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_exe;
				externalChooseBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_list;
				externalFavoriteBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_paint;

				prevButton.Image = hk4tech_picture_viewer.Properties.Resources.white_prev;
				nextButton.Image = hk4tech_picture_viewer.Properties.Resources.white_next;
				slideshowButton.Image = hk4tech_picture_viewer.Properties.Resources.white_slideshow;

				autoZoomButton.Image = hk4tech_picture_viewer.Properties.Resources.white_autozoom;
				zoomInButton.Image = hk4tech_picture_viewer.Properties.Resources.white_zoomin;
				zoomOutButton.Image = hk4tech_picture_viewer.Properties.Resources.white_zoomout;
				zoom100Btn.Image = hk4tech_picture_viewer.Properties.Resources.white_actualsize;

				selectionBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_selection;

				editButton.Image = hk4tech_picture_viewer.Properties.Resources.white_edit;
				rotateLeftButton.Image = hk4tech_picture_viewer.Properties.Resources.white_rotatel;
				rotateRightButton.Image = hk4tech_picture_viewer.Properties.Resources.white_rotater;
				flipHorizontalButton.Image = hk4tech_picture_viewer.Properties.Resources.white_fliph;
				flipVerticalButton.Image = hk4tech_picture_viewer.Properties.Resources.white_flipv;
				rotate180Button.Image = hk4tech_picture_viewer.Properties.Resources.white_degree;
				customAngleBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_angle;
				cropBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_crop;

				infoButton.Image = hk4tech_picture_viewer.Properties.Resources.white_info;

				checkboardButton.Image = hk4tech_picture_viewer.Properties.Resources.white_grid;
				fullscreenBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_fullscreen;
				onTopButton.Image = hk4tech_picture_viewer.Properties.Resources.white_ontop;
				miniViewButton.Image = hk4tech_picture_viewer.Properties.Resources.white_miniview;

				moreButton.Image = hk4tech_picture_viewer.Properties.Resources.white_more;
				wallpaperBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_desktop;
				aboutBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_about;
				reloadButton.Image = hk4tech_picture_viewer.Properties.Resources.white_sync;
				newWindowButton.Image = hk4tech_picture_viewer.Properties.Resources.white_newwindow;
				settingsButton.Image = hk4tech_picture_viewer.Properties.Resources.white_settings;
				backColorBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_palette;
				backClearBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_erase;
				backCustomBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_palette;
				framelessBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_frame;

				selectionLabel.Image = hk4tech_picture_viewer.Properties.Resources.white_selection;
				directoryLabel.Image = hk4tech_picture_viewer.Properties.Resources.white_picfolder;
				fileLabel.Image = hk4tech_picture_viewer.Properties.Resources.white_imgfile;
				sizeLabel.Image = hk4tech_picture_viewer.Properties.Resources.white_size;
				zoomLabel.Image = hk4tech_picture_viewer.Properties.Resources.white_zoom;
				dateCreatedLabel.Image = hk4tech_picture_viewer.Properties.Resources.white_clock;
				dateModifiedLabel.Image = hk4tech_picture_viewer.Properties.Resources.white_history;
				hasChangesLabel.Image = hk4tech_picture_viewer.Properties.Resources.white_erase;

				effectsBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_effects;
				toolsBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_tools;
				pluginManBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_plugin;

				framelessCloseBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_close;

				zoomTextBox.BackColor = ThemeMan.DarkMainColor;
				zoomTextBox.ForeColor = Color.White;

				showMenuItem.Image = hk4tech_picture_viewer.Properties.Resources.white_show;
				showToolbarBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_toolbar;
				showStatusbarBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_statusbar;
				showNavArrowsBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_arrows;
				pasteBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_paste;
				copyBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_copy;
				copyImageBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_image;
				copyFileBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_imgfile;
				selectAllBtn.Image = hk4tech_picture_viewer.Properties.Resources.white_selectall;
			}
		...
		protected override void OnClosing(CancelEventArgs e)
		{
			...
			if (hk4tech_picture_viewer.Properties.Settings.Default.StartupRestoreBounds)
			{
				...
				{
					hk4tech_picture_viewer.Properties.Settings.Default.StartupMaximize = true;
				}
				else
				{
					hk4tech_picture_viewer.Properties.Settings.Default.StartupMaximize = false;
                    hk4tech_picture_viewer.Properties.Settings.Default.StartupWindowLocation = Location;
					hk4tech_picture_viewer.Properties.Settings.Default.StartupWindowSize = Size;
				}
				hk4tech_picture_viewer.Properties.Settings.Default.Save();
			}
		}
			...
			suggestionLabel.Invoke((MethodInvoker)(() =>
			{
				...
				switch (icon)
				{
					case SuggestionIcon.Check:
						suggestionIcon.Image = hk4tech_picture_viewer.Properties.Resources.white_check;
						break;
					case SuggestionIcon.Warning:
						suggestionIcon.Image = hk4tech_picture_viewer.Properties.Resources.white_warning;
						break;
					case SuggestionIcon.Slideshow:
						suggestionIcon.Image = hk4tech_picture_viewer.Properties.Resources.white_slideshow;
						break;
					case SuggestionIcon.Fullscreen:
						suggestionIcon.Image = hk4tech_picture_viewer.Properties.Resources.white_fullscreen;
						break;
					case SuggestionIcon.Next:
						suggestionIcon.Image = hk4tech_picture_viewer.Properties.Resources.white_next;
						break;
					case SuggestionIcon.Prev:
						suggestionIcon.Image = hk4tech_picture_viewer.Properties.Resources.white_prev;
						break;
					case SuggestionIcon.Trash:
						suggestionIcon.Image = hk4tech_picture_viewer.Properties.Resources.white_trash;
						break;
					default:
						suggestionIcon.Image = hk4tech_picture_viewer.Properties.Resources.white_info;
						break;
				}
		...
		{
			Process.Start(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "hk4tech-picture-viewer.exe"));
		}
		...
		private void externalFavoriteBtn_Click(object sender, EventArgs e)
		{
			try
			{
				Process.Start(hk4tech_picture_viewer.Properties.Settings.Default.FavoriteExternalApp, '"' + Path.Combine(currentFolder, currentFile) + '"');
			}
			catch
			{
				showSuggestion(LangMan.Get("unable-to-run-external-app"), SuggestionIcon.Warning);
		...
		{
			int lastSlashIndex = hk4tech_picture_viewer.Properties.Settings.Default.FavoriteExternalApp.LastIndexOf('/');
			if (lastSlashIndex == -1) lastSlashIndex = hk4tech_picture_viewer.Properties.Settings.Default.FavoriteExternalApp.LastIndexOf('\\');

			if (lastSlashIndex >= 0)
			{
				string appName = hk4tech_picture_viewer.Properties.Settings.Default.FavoriteExternalApp.Substring(
					lastSlashIndex + 1, 
					hk4tech_picture_viewer.Properties.Settings.Default.FavoriteExternalApp.Length - lastSlashIndex - 1
				);
		...
		private void backCustomBtn_Click(object sender, EventArgs e)
		{
			if (colorDialog1.ShowDialog() == DialogResult.OK)
			{
				...
				hk4tech_picture_viewer.Properties.Settings.Default.BackColor = colorDialog1.Color.ToArgb().ToString();
				hk4tech_picture_viewer.Properties.Settings.Default.Save();
			}
		...
		{
			PluginInfo[] plugins = PluginMan.GetPluginsCache(hk4tech_picture_viewer.Properties.Settings.Default.PluginsCache);
			...
			for (int i = 0; i < plugins.Length; i++)
			{
				for (int j = 0; j < plugins[i].functions.Length; j++)
				{
					...
					PluginMenuItem tsmi = new PluginMenuItem(
						...
						hk4tech_picture_viewer.Properties.Settings.Default.Language,
						darkMode
					);
		...
		{
			if (!fullscreen) statusStrip1.Visible = !hk4tech_picture_viewer.Properties.Settings.Default.ShowStatusBar;
			hk4tech_picture_viewer.Properties.Settings.Default.ShowStatusBar = !hk4tech_picture_viewer.Properties.Settings.Default.ShowStatusBar;
			hk4tech_picture_viewer.Properties.Settings.Default.Save();
		}

		private void showToolbarBtn_Click(object sender, EventArgs e)
		{
			if (!fullscreen) toolStrip1.Visible = !hk4tech_picture_viewer.Properties.Settings.Default.ShowToolbar;
			hk4tech_picture_viewer.Properties.Settings.Default.ShowToolbar = !hk4tech_picture_viewer.Properties.Settings.Default.ShowToolbar;
			hk4tech_picture_viewer.Properties.Settings.Default.Save();
		}
		...
		//	pmf.ShowDialog();
		//	pmf.Dispose();
            MB("Plugin Manager Soon", "HK4TECH Picture Viewer", MessageBoxIcon.Information);
		}
		...
		private void nextButton_VisibleChanged(object sender, EventArgs e)
		{
			...
			hk4tech_picture_viewer.Properties.Settings.Default.ShowNavArrows = !nextButton.Visible;
			hk4tech_picture_viewer.Properties.Settings.Default.Save();
			showNavArrowsBtn.Checked = hk4tech_picture_viewer.Properties.Settings.Default.ShowNavArrows;
		}
